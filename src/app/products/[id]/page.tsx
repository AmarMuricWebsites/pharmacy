  ...
  return (
    <div className="container px-4 py-8 md:px-6 md:py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
        <div className="bg-white rounded-lg overflow-hidden border grid place-items-center">
          <Pill />
        </div>
        ...
        <div className="flex flex-col">
                ...
                <Star
                  ...
                  className={`h-5 w-5 ${
                    ...
                    i === Math.floor(product.rating) && product.rating % 1 > 0
                      ? "fill-gradient-to-r from-yellow-400 to-gray-200"
                      : ""
                  }`}
                />
              ))}
          ...
          <div className="text-sm text-muted-foreground mb-6">
            <p className="mb-2">
              ...
              Please visit our pharmacy or call us to check current
              availability.
            </p>
            <p className="mb-2">
            ...
            <p>
              <span className="font-medium text-foreground">SKU:</span> MED-
